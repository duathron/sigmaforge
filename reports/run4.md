...
run4 measures each rule against **only the attack events of its own ATT&CK (sub-)technique(s)**: `recall = (unique matching events the rule fired on) / (total matching events)`.

**FIX B2 — sub-technique-granular scoping (no sibling dilution).** Technique IDs are kept at full sub-technique granularity on BOTH sides (rule tag and corpus event); they are NOT folded to parent. Matching is **asymmetric**: an attack event of technique X counts toward rule R iff (a) X is exactly one of R's (sub-)technique tags — so a `T1059.001` (PowerShell) rule is scored against `T1059.001` events ONLY, never its `T1059.003` (Windows Command Shell) siblings — OR (b) R carries a **bare parent** tag (e.g. `T1059` with no sub-technique) and X is any child of it (`T1059.*`), since a generic rule legitimately covers the whole technique. The earlier fold-to-parent merged a `T1059.001` rule against the whole `T1059` pool (and sibling sub-techniques), inflating the denominator and deflating recall. Rules with no technique tag, or whose tags match zero attack events in the corpus, are **`unmeasured`** (NOT 0, NOT pooled).

- **rule -> technique coverage:** 555/609 loaded rules carry a usable `attack.tXXXX` tag.
- **recall-measurable rules:** 179/609 (technique present in the corpus); **unmeasured:** 430.
...
- per-technique corpus: **1214** process-creation events across **36** distinct techniques — **12** at sub-technique granularity (e.g. `T1059.001`, `T1059.003`) + **24** bare-parent buckets (corpus folder carries no sub-technique, or a `Txxxx.xxx` unknown-sub placeholder). **279** EVTX files mapped to a technique, **14** unmappable (non-`TAxxxx`-foldered helper dirs — excluded, NOT silently counted).
- technique skew (HONEST): the corpus is dominated by `T1027`=742, `T1059.003`=140, `T1059.001`=58, `T1021.001`=33, `T1070.001`=29 — recall for low-population (sub-)techniques rests on very few events.
- worked example (the sibling-dilution bug, fixed): **HackTool - CrackMapExec PowerShell Obfuscation** is tagged `attack.t1059.001` + `attack.t1027.005`. Under the old fold-to-parent it scored **1/940** (denom = T1027=742 + T1059=198, merging both parents and every sibling sub-technique). Sub-technique-granular: `T1059.001`=58 matching events (sibling `T1059.003`=140 excluded), and `T1027.005` has **no** corpus bucket (the corpus holds only bare `T1027`, which a sub-technique tag does NOT match) — so its denom is **58**, recall **0/58 = 0.0** (the lone old 'hit' was a fire on an off-technique sibling event that never should have counted).
...
| Suspicious Child Process Of BgInfo.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| HackTool - Pypykatz Credentials Dumping Activity | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Doppelanger LSASS Dumper Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Csc.EXE Execution Form Potentially Suspicious Parent | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Xwizard.EXE Execution From Non-Default Location | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Sensitive File Recovery From Backup Via Wbadmin.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Sensitive File Dump Via Print.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - SafetyKatz Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Tasks Folder Evasion | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Invoke-Obfuscation Via Stdin | 0.0 | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Sensitive File Dump Via Wbadmin.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Potential Defense Evasion Activity Via Emoji Usage In CommandLine - 3 | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Suspicious LNK Command-Line Padding with Whitespace Characters | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| MMC Executing Files with Reversed Extensions Using RTLO Abuse | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Windows Credential Editor (WCE) Execution | unmeasured | unmeasured | 0 | 0 | 15092 | 15092 | n/a (unmeasured) |
| PUA - AdFind Suspicious Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Abuse of Service Permissions to Hide Services Via Set-Service | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| WMI Backdoor Exchange Transport Agent | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Service DACL Abuse To Hide Services Via Sc.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Process Memory Dump via RdrLeakDiag.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| VolumeShadowCopy Symlink Creation Via Mklink | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious DumpMinitool Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - KrbRelayUp Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Script Interpreter Spawning Credential Scanner - Windows | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential Privilege Escalation via Service Permissions Weakness | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| PUA - DIT Snapshot Viewer | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| PPL Tampering Via WerFaultSecure | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential Adplus.EXE Abuse | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - XORDump Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Persistence Via Sticky Key Backdoor | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Inveigh Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Reconnaissance Activity Via GatherNetworkInfo.VBS | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| DLL Sideloading by VMware Xfer Utility | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Interactive AT Job | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Cscript/Wscript Uncommon Script Extension Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| CreateDump Process Dump | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| PUA - Suspicious ActiveDirectory Enumeration Via AdFind.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Debugger Registration Cmdline | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Quarks PwDump Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Dumping of Sensitive Hives Via Reg.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - CreateMiniDump Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Time Travel Debugging Utility Usage | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Outlook Child Process | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Suspicious WebDav Client Execution Via Rundll32.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Potential Credential Dumping Via WER | unmeasured | unmeasured | 0 | 0 | 16465 | 16303 | n/a (unmeasured) |
| Renamed AdFind Execution | unmeasured | unmeasured | 0 | 0 | 15092 | 15092 | n/a (unmeasured) |
...
| Potential Mpclient.DLL Sideloading Via Defender Binaries | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - CrackMapExec Process Patterns | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Binary In User Directory Spawned From Office Application | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Winrs Local Command Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Mimikatz Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - Dumpert Process Dumper Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Process Memory Dump Via Comsvcs.DLL | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| PowerShell SAM Copy | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Process Access via TrolleyExpress Exclusion | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential Windows Defender AV Bypass Via Dump64.EXE Rename | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential Privilege Escalation Using Symlink Between Osk and Cmd | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Process Patterns NTDS.DIT Exfil | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| PUA - Netcat Suspicious Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Renamed CreateDump Utility Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Copying Sensitive Files with Credential Data | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - SharpUp PrivEsc Tool Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential SysInternals ProcDump Evasion | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Sticky Key Like Backdoor Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| New ActiveScriptEventConsumer Created Via Wmic.EXE | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - HandleKatz LSASS Dumper Execution | unmeasured | unmeasured | 0 | 0 | 15092 | 15092 | n/a (unmeasured) |
...
| Rundll32 Registered COM Objects | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Potential LSASS Process Dump Via Procdump | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| HackTool - WSASS Execution | unmeasured | unmeasured | 0 | 0 | 15092 | 15092 | n/a (unmeasured) |
...
| LSASS Dump Keyword In CommandLine | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Suspicious Active Directory Database Snapshot Via ADExplorer | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Possible Privilege Escalation via Weak Service Permissions | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| Renamed Vmnat.exe Execution | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
| Suspicious GUP Usage | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
...
| New User Created Via Net.EXE With Never Expire Option | unmeasured | unmeasured | 0 | 0 | 17124 | 16962 | n/a (unmeasured) |
